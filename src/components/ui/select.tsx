...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full cursor-pointer select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-sm outline-none transition-colors focus:bg-[#1e4b7a] focus:text-white hover:bg-[#1e4b7a] hover:text-white data-[highlighted]:bg-[#1e4b7a] data-[highlighted]:text-white data-[state=checked]:text-[#1e4b7a] data-[state=checked]:font-bold data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
      className
    )}
    {...props}
  >
